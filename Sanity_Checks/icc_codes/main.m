...
for layout_id = 1:500
    ...
    for alg = algorithms   
        ...
        [ numSchedule{alg}, rate{alg}, whether_encountered ]= obj{alg}.computeAvgRate();
    end
    
    if whether_encountered
        disp('found zero avg rate inside computeAvgRate. Exiting...')
        break
    end
